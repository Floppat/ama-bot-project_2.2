...
async def prehistory(interaction: discord.Interaction) -> str:
    ...
    return ('...однажды на прогулке, средь бела дня небо заволокло тучами, что само солнце погасло, и шаровя молния устремилась в вас.\n'
            'За мгновение до рокового столкновения она остановилась, и из шара света появилось невиданное ранее существо. весьма пушистое!\n'
            'Оно, похоже, было разумным, и по какой то причине смотрело на вас. когда вы прикрикнули "Отойди!" оно послушно отошло...\n'
            'По какой то причине, существо слушалось вас. Неприкословно. На следующую же ночь к вам пришло озарение: тёмплый, но встевоженный голос\n'
            '"Помоги... Ты и моё дитя... Вам следует спасти жизнь мира... "\n'
            'На этом сон оборвался. Вы как бы и не придале этому значения, и забыли бы, вот только когда пошли выкинуть мусор... Существо ждало за дверью?!\n' 
            'Вам предстоит понять что это всё значит, и ужится с неведомым существом. но это всё позже, потому что на заднем дворе есть похожие животные....\n'
            '...Но мех их - чёрный как смола. И они бегут на вас! Ваш новоприобретённый питомец на них оскалился и ждёт ваших команд!\n')
